...
% -*- coding: UTF-8; -*-
% vim: set fenc=utf-8
\documentclass[10pt,french,a4paper,twoside]{article}%,oneside,draft
%============ common ===================
...
Laurent Perrinet est un chercheur en neuroscience 
...
\newpage
\section{Rapport d’activité sur la période de décembre 2016 à décembre 2021} %{\small(journaux à  comité de lecture)}}
...
\begin{itemize}
	\item ``\href{https://laurentperrinet.github.io/post/2021-10-04_interstices/}{Horizon Faille}'' – interstices, à Caen\years{2021},
