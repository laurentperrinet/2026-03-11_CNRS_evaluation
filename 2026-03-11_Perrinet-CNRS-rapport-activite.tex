...
Cette thématique est actuellement développée par Alexandre Lainé (thèse débutée en octobre 2024, co-direction avec Sophie Denève), appliquée au Marmouset avec une technologie d'enregistrement basée sur des \emph{Neuropixels} obtenus auprès de niotre collaborateur à l'université du Texas à Austin, Nicholas Priebe. Une première présentation affichée a été donnée lors du congrès CNS~2025 à Florence~\citep{Laine25cns}, et un article est en cours de préparation.
...
Les trois axes de mes recherches accomplies dans la période de référencesont étroitement interconnectés, ce qui nécessite une forte interdisciplinarité. Mon intégration à l'INT permet de bien couvrir la composante expérimentale, et j'ai pu développer des collaborations pour les aspects de modélisation et de formalisation théorique. Dans cette optique, nous avons récemment créé le centre de neurosciences computationnelles \href{https://conect-int.github.io/}{CONECT} à l'INT. Une perspective est de développer cette approche grâce à des collaborations nationales grâce au nouvellement créé Groupe de Travail en Neurosciences computationnelles (coordinataion: Laura Dugué et Matthieu Gilson) et internationales, notamment à travers le centre AISSAI du CNRS.
