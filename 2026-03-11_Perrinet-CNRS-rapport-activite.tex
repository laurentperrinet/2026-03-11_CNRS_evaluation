...
Les trois axes de mes recherches accomplies dans la période de référence sont étroitement interconnectés, ce qui nécessite une forte interdisciplinarité. Mon intégration à l'INT permet de bien couvrir la composante expérimentale, et j'ai pu développer des collaborations pour les aspects de modélisation et de formalisation théorique. Dans cette optique, nous avons récemment créé le centre de neurosciences computationnelles \href{https://conect-int.github.io/}{CONECT} à l'INT. Une perspective est de développer cette approche grâce à des collaborations nationales grâce au nouveau Groupe de Travail en Neurosciences computationnelles (coordination: Laura Dugué et Matthieu Gilson) et internationales, notamment à travers le centre AISSAI du CNRS.
