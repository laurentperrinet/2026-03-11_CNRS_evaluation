...
Cette thématique est actuellement développée par Alexandre Lainé (thèse débutée en octobre 2024, co-direction avec Sophie Denève), appliquée au Marmouset avec une technologie d'enregistrement basée sur des \emph{Neuropixels} obtenus auprès de niotre collaborateur à l'université du Texas à Austin, Nicholas Priebe. Une première présentation affichée a été donnée lors du congrès CNS~2025 à Florence, et un article est en cours de préparation.
