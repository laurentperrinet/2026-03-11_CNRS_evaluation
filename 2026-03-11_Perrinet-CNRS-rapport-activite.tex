...
À l'horizon 2030, l'ambition est de disposer d'un corpus cohérent et normativement fondé reliant les mécanismes cellulaires du codage prédictif, depuis la modulation neuromodulatrice du micro-circuit à la planification du regard, et d'en avoir extrait des algorithmes neuromorphiques dont la sobriété et la robustesse ouvrent de nouvelles perspectives pour une intelligence artificielle inspirée ---et au service--- de l'intelligence naturelle.
\newpage
\printbibliography
\end{document} %
